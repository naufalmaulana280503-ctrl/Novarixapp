...
export default function DonationAlertOverlay({ streamId }) {
  ...
  return (
    <div style={{position:'absolute', top:16, left:16, zIndex:3000, display:'flex', flexDirection:'column', gap:8, maxWidth:300}}>
...
const styles = {
  settings: { display: 'grid', gridTemplateColumns: '1fr auto', gap: 6, alignItems: 'center', background: 'rgba(17,24,39,0.94)', border: '1px solid rgba(255,255,255,0.14)', borderRadius: 10, padding: 10, color: '#fff', fontSize: 11 },
